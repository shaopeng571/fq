...
public class QMainActivity extends Activity implements OnClickListener {
 private String uid;
 private HySDKManager hySDKManager;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		hySDKManager.initCommonSdk(QMainActivity.this, initInfo, sdkcallback);
try {
	JSONObject jsonObject=new JSONObject("﻿{\"code\":\"1\",\"msg\":\"登录成功！\",\"data\":{\"user_id\":\"ohRWw0fR0CjZQFnxyJeKy04JA0B0\",\"user_name\":\"ohRWw0fR0CjZQFnxyJeKy04JA0B0\",\"token\":\"2B6F840B9803193DDB833004F196EA85\",\"la\":\"\"}}");
...
//			Log.e("fq", "登录成功！！！"+arg0);
			...
			case 0:// 登录成功
				try {
					...
					Toast.makeText(QMainActivity.this, "登录成功！", 0).show();
					...
					if (TextUtils.isEmpty(uid)) {
						...
						if (TextUtils.isEmpty(uid)) {
							// 重新显示登录页面
							hySDKManager.showLoginView(QMainActivity.this, null);
						}
					}
					QMainActivity.this.uid=uid;
					// sendExtData();
				} catch (JSONException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
	...
	public void onClick(View v) {
		...
		case 1:
			...
			hySDKManager.showChargeView(QMainActivity.this, hyPayInfo);
			break;
		case 2:
			...
			hySDKManager.sendExtendDataRoleCreate(QMainActivity.this, rolecreate_data);
			break;
		case 3:
			...
			data.setUser_id(uid);
			hySDKManager.sendExtendData(QMainActivity.this, data);
			break;
		case 4://角色升级
			...
			hySDKManager.sendExtendDataRoleLevelUpdate(QMainActivity.this, data3);
			break;
		case 5://角色退出
			...
			hySDKManager.sendExtendDataRoleLogout(QMainActivity.this, data4);
			break;
		case 6:
			hySDKManager.showReLogionView(QMainActivity.this, null);
			break;
		default:
			break;
		}
	...
	protected void onStart() {
		// TODO Auto-generated method stub
		super.onStart();
//		hySDKManager.onStart(QMainActivity.this);
	}
	...
	protected void onRestart() {
		// TODO Auto-generated method stub
		super.onRestart();
		hySDKManager.onRestart(QMainActivity.this);
	}
	...
	protected void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		hySDKManager.onResume(QMainActivity.this);
//		hySDKManager.controlFlowView(this, true);
	...
	protected void onStop() {
		// TODO Auto-generated method stub
		super.onStop();
		hySDKManager.onStop(QMainActivity.this);
	}
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();
		hySDKManager.onDestroy(QMainActivity.this);
//		System.exit(0);
	}
