...
public class platformApi implements com.fqwl.hycommonsdk.present.apiinteface.SdkApi,IRoleDataAnaly,IApplication{
	...
	public void init(Activity activity, CommonSdkInitInfo commonSdkInitInfo, final CommonSdkCallBack callBack, ImplCallback implCallback) {
		...
		HySDK.getInstance().HyInitSDK(activity, initInfo,new FQSdkCallBack() {
			...
			@Override
			public void loginOnFinish(int arg0, HyLoginResult arg1) {
				// TODO Auto-generated method stub
				
			}
			
			@Override
			public void initOnFinish(int arg0, String arg1) {
				// TODO Auto-generated method stub
	...
	public void login(Activity activity, CommonSdkLoginInfo initInfo) {
		// TODO Auto-generated method stub
		HySDK.getInstance().HyShowLoginView(activity, new FQSdkCallBack() {
			...
			@Override
			public void loginOnFinish(int ret, HyLoginResult paramUser) {
				// TODO Auto-generated method stub
				switch (ret) {
				case 0:// 登录成功
...
//	private com.tomato.fqsdk.clinterface.HyInterface.OnLoginFinishedListener loginFinishedListener=
	@Override
...
//						implCallback.onLoginVerify(result_data);	
	...
	@Override
	public void initGamesApi(Application arg0) {
		// TODO Auto-generated method stub
		HySDK.getInstance().getApplication(arg0);
	}

	@Override
	public void initPluginInAppcation(Application arg0, Context arg1) {
		// TODO Auto-generated method stub
