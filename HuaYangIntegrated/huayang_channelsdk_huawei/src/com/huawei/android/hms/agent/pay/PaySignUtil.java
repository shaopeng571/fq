...
public final class PaySignUtil {
    ...
    public static String calculateSignString(PayReq request, String privKey) {
    	String before = getStringForSign(request);
    	FLogger.d("TEST", "before rsa:"+before);
    	String after = rsaSign(getStringForSign(request), privKey);
    	FLogger.d("TEST", "after rsa:"+after);
        return after;
    }
