...
public class ResUtils {
	...
	public int getIdResByName(Activity activity,String name) {
	...
	public int getLayoutResByName(Activity activity,String name) {
		
		int x = activity.getResources().getIdentifier(name, "layout", activity.getPackageName());
		return x;
	}
