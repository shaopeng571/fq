...
public class FLogger {
	...
	private static String[] wrapperContent(int stackTraceIndex, String tagStr,String msg) {
		...
		StackTraceElement targetElement = stackTrace[stackTraceIndex];// com.example.androidtest2.MainActivity$1.onClick(SplashActivity.java:26)
		...
		//headString : [ (SplashActivity.java:28)#onCreate ]
