...
public class NetWorkUtil {  
    ...
    public static boolean isWifiAvailable(Context ConfigManager) {  
     ...
     * @return 
     */  
    public static String getProvider(Context ConfigManager) {  
...
//     * @return 
//     */  
//    public static HJNetTypeEnum getCurrentNetworkType(Context context) {  
//        int networkClass = getNetworkClass(context);  
//        HJNetTypeEnum type = null;  
//        try {
//              switch (networkClass) {  
//              case NETWORK_CLASS_UNAVAILABLE:  
//                  type = HJNetTypeEnum.Other;  
//                  break;  
//              case NETWORK_CLASS_WIFI:  
//                  type = HJNetTypeEnum.WIFI;  
//                  break;  
//              case NETWORK_CLASS_2_G:  
//                  type = HJNetTypeEnum._2G;  
//                  break;  
//              case NETWORK_CLASS_3_G:  
//                  type = HJNetTypeEnum._3G;  
//                  break;  
//              case NETWORK_CLASS_4_G:  
//                  type = HJNetTypeEnum._4G;  
//                  break;  
...
//    }  
    ...
    private static int getNetworkClass(Context ConfigManager) {  
    ...
    public static String getWifiRssi(Context ConfigManager) {  
        int asu = 85;  
        try {  
            final NetworkInfo network = ((ConnectivityManager) ConfigManager  
                    .getSystemService(Context.CONNECTIVITY_SERVICE))  
    ...
    public static String getWifiSsid(Context ConfigManager) {  
        String ssid = "";  
        try {  
            final NetworkInfo network = ((ConnectivityManager) ConfigManager  
                    .getSystemService(Context.CONNECTIVITY_SERVICE))  
     ...
     * @return 
     */  
    public static boolean checkSimState(Context ConfigManager) {  
        TelephonyManager tm = (TelephonyManager) ConfigManager
                .getSystemService(Context.TELEPHONY_SERVICE);  
     ...
     * 获取imei 
     */  
    public static String getImei(Context ConfigManager) {  
    ...
    public static String getPhoneImsi(Context ConfigManager) {  
        TelephonyManager mTelephonyMgr = (TelephonyManager) ConfigManager  
                .getSystemService(Context.TELEPHONY_SERVICE);  
        return mTelephonyMgr.getSubscriberId();  
    }  
  
//    public static CellInfo getNetInfo(Context ConfigManager) {  
